...
export default function Stack() {
   ...
   return (
      <Container maxW={isLargerThanMD ? "1200px" : "100%"} p={padding} overflowY={isLargerThanMD ? "auto" : "scroll"} h="80vh" display="flex" flexDirection="column" justifyContent="space-between">
